                                            ...
                                            if(mysqli_num_rows($query_run) > 0){
                                                foreach($query_run as $teaching){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_teaching.php?id=<?= $teaching['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                        </td>
                                                        <td>                                         <!--在同一行-->
                                                            <form action="receive.php" method="POST" class="d-inline">
                                                                <button type="submit" name="delete_teaching" value="<?=$teaching['id'];?>" class="btn btn-danger btn-sm">Delete</button>
                                                            </form>
                                                        </td>
                                                    </tr>
                                                    <?php
                                            ...
                                            if(mysqli_num_rows($query_run) > 0){
                                                foreach($query_run as $notice){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_notice.php?id=<?= $notice['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                        </td>
                                                        <td>
                                                            <form action="receive.php" method="POST" class="d-inline">
                                                                <button type="submit" name="delete_notice" value="<?=$notice['id'];?>" class="btn btn-danger btn-sm">Delete</button>
                                                            </form>
                                                        </td>
                                                    </tr>
                                                    <?php
